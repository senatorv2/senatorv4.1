...
--pm = pm..'\n💈 <code>Lock Flood</code> : '..(group[tostring(target)]['settings']['lock_flood'] or 'no')..''
pm = pm..'\n💈 <code>Lock Fosh</code> : '..(group[tostring(target)]['settings']['lock_fosh'] or 'no')..''
pm = pm..'\n💈 <code>Lock Tgservice</code> : '..(group[tostring(target)]['settings']['lock_tgservice'] or 'no')..''
pm = pm..'\n💈 <code>Lock Sticker</code> : '..(group[tostring(target)]['settings']['lock_sticker'] or 'no')..''
--pm = pm..'\n💈 <code>Lock Bot</code> : '..(group[tostring(target)]['settings']['lock_bot'] or 'no')..''
pm = pm..'\n💈 <code>Lock Inline</code> : '..(group[tostring(target)]['settings']['lock_inline'] or 'no')..''
...
--pm = pm..'\n💈     🔧<b>Mute</b>🔧'
pm = pm..'\n💈 <code>Lock Gifs</code> : '..(group[tostring(target)]['settings']['mute_gif'] or 'no')..''
...
pm = pm..'\n💈 <code>Mute All</code> : '..(group[tostring(target)]['settings']['mute_all'] or 'no')..''
pm = pm..'\n🚏🚏🚏🚏🚏🚏🚏\n\n<b>Channel: </b>@senator_tea'
...
pm = pm..'\n💈 <code>Lock Fosh</code> : '..group[tostring(target)]['settings']['lock_fosh']..''
pm = pm..'\n💈 <code>Lock Tgservice</code> : '..group[tostring(target)]['settings']['lock_tgservice']..''
pm = pm..'\n💈 <code>Lock Sticker</code> : '..group[tostring(target)]['settings']['lock_sticker']..''
...
pm = pm..'\n💈 <code>Lock Inline</code> : '..group[tostring(target)]['settings']['lock_inline']..''
...
--pm = pm..'\n💈     🔧<b>Mute</b>🔧'
pm = pm..'\n💈 <code>Lock Gifs</code> : '..group[tostring(target)]['settings']['mute_gif']..''
...
pm = pm..'\n💈 <code>Mute All</code> : '..group[tostring(target)]['settings']['mute_all']..''
pm = pm..'\n🚏🚏🚏🚏🚏🚏🚏\n<b>Channel: </b>@senator_tea'
tg.sendMessage(msg.chat_id_, 0, 1, pm, 1, 'html')
end
